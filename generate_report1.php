...
<body>
  ...
  <div class="report-container">
    ...
    <p>Select a time period and view mode to analyze booking trends.</p>
  ...
  // Load booking details for the selected period
  ...
  // Handle dropdown selection change for range
  document.getElementById("dateRange").addEventListener("change", function() {
    currentRange = this.value;
    loadChart();
  });

  // Handle dropdown selection change for view type
